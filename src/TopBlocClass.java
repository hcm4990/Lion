...
public class TopBlocClass {
	...
	public static void main(String[] args) throws IOException {
        ...
        String email = "harishm365@gmail.com";
        String name = "Harish Mundluru";
        // The following 22 lines post the required data to the server
        try {
			...
			jsonInputString = "{ id: " + email + ", name: " + name + ", average: "
